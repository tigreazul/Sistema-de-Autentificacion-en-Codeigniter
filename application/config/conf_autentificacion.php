...
/**
* Name:  Configuracion Autentificacion
*
* Version: 0.1
*
* Author: Junior Tello
...
*/
$config['tables']['usuario']    = 'tbl_usuario';
$config['tables']['rol']        = 'tbl_rol';
$config['tables']['pagina']     = 'tbl_pagina';
$config['tables']['modulo']     = 'tbl_modulo';
$config['tables']['permiso']    = 'tbl_permisos';
$config['tables']['intentos_acceso']  = 'tbl_intentos_acceso';



$config['identity']                   = 'usu_email';
$config['hash_normal']                = FALSE;


$config['key_code_pass']                = '4fafd2add7d75';
/*
...
$config['admin_email']                = "zkated@example.com"; // Admin Email, admin@example.com

$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name

// $config['identity']                   = 'usu_email';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
...
$config['email_from'] = 'tello_jr2@hotmail.com';
$config['name_from'] = 'Juan Perez';
$config['email_asunto'] = 'Mensaje de prueba';
