...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo ruta()?>plugins/iCheck/square/blue.css">
    <script type="text/javascript">var app = { base : '<?php echo site_url()."/"; ?>' };</script>
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo base_url() ?>">
            <img src="<?php echo ruta()?>assets/images/logo.png">
        </a>
    </div>
    <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?php echo ruta()?>plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
